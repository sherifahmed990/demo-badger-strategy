...
contract SqrtPriceMathEchidnaTest {
    ...
    function getAmount0DeltaInvariants(
        ...
        uint256 amount0Down =
            SqrtPriceMath.getAmount0Delta(sqrtQ, sqrtP, liquidity, false);
        assert(
            amount0Down ==
    ...
    function getAmount0DeltaEquivalency(
        ...
        uint256 fullResult =
            SqrtPriceMath.getAmount0Delta(sqrtQ, sqrtP, liquidity, roundUp);
    ...
    function getAmount1DeltaInvariants(
        ...
        uint256 amount1Down =
            SqrtPriceMath.getAmount1Delta(sqrtP, sqrtQ, liquidity, false);
        assert(
            amount1Down ==
    ...
    function getInRangeMintInvariants(
        ...
        int256 amount0 =
            SqrtPriceMath.getAmount0Delta(sqrtCurrent, sqrtUpper, liquidity);
        int256 amount1 =
            SqrtPriceMath.getAmount1Delta(sqrtLower, sqrtCurrent, liquidity);
